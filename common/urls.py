...
Examples:
Function views
    1. Add an import:  from caesar-common import views
...
from common.rest.views import status_api, Icinga2API, FileAPI
...
urlpatterns = [
    ...
    # Documentation
    url(r'^docs/', include_docs_urls(title='Caesar Common API')),
