...
from common.rest.tests.base import BaseTestCase
...
class ViewTestCase(BaseTestCase):
    ...
    def test_api_file_with_credential_good_key(self):
        with open('./caesar_auth/rest/tests/files/file_ok.json') as f:
            file_content = f.read()
    ...
    def test_api_file_with_credential_wrong_key(self):
        with open('./caesar_auth/rest/tests/files/file_ko.json') as f:
            file_content = f.read()
            json_file_content = json.loads(file_content)
        response = self.basics_auth_post(
            reverse('api_file'),
